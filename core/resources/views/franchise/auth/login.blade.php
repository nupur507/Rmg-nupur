    ...
    <div class="page-wrapper default-version">
        <div class="form-area bg_img" data-background="{{asset('assets/admin/images/1.jpg')}}">
            <div class="form-wrapper">
                ...
                <form action="{{ route('franchise.login') }}" method="POST" class="cmn-form mt-30">
                    @csrf
                    <div class="form-group">
                        <label for="email">@lang('Franchise ID')</label>
                        <input type="text" name="franchise_id" class="form-control b-radius--capsule" id="username" value="{{ old('franchise_id') }}" placeholder="@lang('Enter your Franchise ID')">
