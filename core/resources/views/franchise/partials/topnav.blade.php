            ...
            <li class="dropdown">
                <button type="button" class="" data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="navbar-user">
                        {{-- <span class="navbar-user__thumb"><img src="{{ getImage('assets/admin/images/profile/'. auth()->guard('franchise')->user()->image) }}" alt="@lang('image')"></span> --}}

                        <span class="navbar-user__info">
                        <span class="navbar-user__name">{{auth()->guard('franchise')->user()->franchise_name}}</span>
                        </span>
