    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.users*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.users.kyc')}} ">
                                <a href="{{route('admin.users.kyc')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All KYC')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.franchise*',3)}}">
                        <i class="menu-icon las la-gift"></i>
                        <span class="menu-title">@lang('Franchise')</span>
                    </a>

                    <div class="sidebar-submenu {{menuActive('admin.franchise*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item">
                                <a href="{{route('admin.franchise.list')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.stock*',3)}}">
                        ...
                        <span class="menu-title">@lang('Stock')</span>
                    </a>

                    <div class="sidebar-submenu {{menuActive('admin.stock*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item">
                                <a href="{{route('admin.stock.franchise.orderRequest')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Franchise Order Request')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.setting.autopool')}}">
                    <a href="{{route('admin.setting.autopool')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Autopool Setting')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{menuActive('admin.setting.reward')}}">
                    <a href="{{route('admin.setting.reward')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Reward Setting')</span>
                    </a>
                </li>
