        ...
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <h6 class="card-title mb-20">@lang('Product Update Form')</h6>
                                        ...
                                        <div class="col-md-4">
                                           <div class="form-group">
                                               ...
                                               <div class="input-group">
                                                   <input type="text" name="mrp" class="form-control border-radius-5" value="{{ $product->mrp }}"/>
                                               </div>
                                           </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="dp" class="form-control border-radius-5" value="{{ $product->dp }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="card border--primary mb-2">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="input-group has_append mb-3">
                                                    <input type="text" class="form-control" name="bv" placeholder="0" value="{{ $product->bv }}"/>
                                                    
                                                </div>

                                                <label class="font-weight-bold">@lang('PV') <span class="text-danger">*</span></label>
                                                <div class="input-group has_append">
                                                    <input type="text" class="form-control" placeholder="0" name="pv" value="{{ $product->pv }}"/>
                                        ...
                                        <div class="card border--primary">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" placeholder="0" name="gst" value="{{ $product->gst }}"/>
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="0" name="hsn_code" value="{{ $product->hsn_code }}">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border--dark my-2">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea rows="5" class="form-control border-radius-5 nicEdit" name="instruction">{{ $product->description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
