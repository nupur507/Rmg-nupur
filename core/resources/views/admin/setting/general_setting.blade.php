                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 ">
                                ...
                                <select name="matching_bonus_time" class="form-control form-control-lg">
                                    <option value="daily_twice">@lang('Daily Twice')</option>
                                    <option value="daily">@lang('Daily')</option>
                                    <option value="weekly">@lang('Weekly')</option>
                                    <option value="monthly">@lang('Monthly')</option>
                                </select>
                            </div>
                            <div class="form-group col-md-4" id="daily_twice_time" style="display:none;">
                                <label>@lang('Daily Time')</label>
                                @php
                                  $selectedbonus =[];
                                    if($general->matching_bonus_time=="daily_twice"){
                                        $selectedbonus = explode(',',$general->matching_when);
                                    }
                                @endphp
                                <select name="daily_twice_time[]" class="form-control select2-auto-tokenize" multiple="multiple">
                                    <option value="1" @if(in_array('1',$selectedbonus))  {{'selected'}}  @endif>@lang('01:00')</option>
                                    <option value="2" @if(in_array('2',$selectedbonus))  {{'selected'}}  @endif>@lang('02:00')</option>
                                    <option value="3" @if(in_array('3',$selectedbonus))  {{'selected'}}  @endif>@lang('03:00')</option>
                                    <option value="4" @if(in_array('4',$selectedbonus))  {{'selected'}}  @endif>@lang('04:00')</option>
                                    <option value="5" @if(in_array('5',$selectedbonus))  {{'selected'}}  @endif>@lang('05:00')</option>
                                    <option value="6" @if(in_array('6',$selectedbonus))  {{'selected'}}  @endif>@lang('06:00')</option>
                                    <option value="7" @if(in_array('7',$selectedbonus))  {{'selected'}}  @endif>@lang('07:00')</option>
                                    <option value="8" @if(in_array('8',$selectedbonus))  {{'selected'}}  @endif>@lang('08:00')</option>
                                    <option value="9" @if(in_array('9',$selectedbonus))  {{'selected'}}  @endif>@lang('09:00')</option>
                                    <option value="10" @if(in_array('10',$selectedbonus))  {{'selected'}}  @endif>@lang('10:00')</option>
                                    <option value="11" @if(in_array('11',$selectedbonus))  {{'selected'}}  @endif>@lang('11:00')</option>
                                    <option value="12" @if(in_array('12',$selectedbonus))  {{'selected'}}  @endif>@lang('12:00')</option>
                                    <option value="13" @if(in_array('13',$selectedbonus))  {{'selected'}}  @endif>@lang('13:00')</option>
                                    <option value="14" @if(in_array('14',$selectedbonus))  {{'selected'}}  @endif>@lang('14:00')</option>
                                    <option value="15" @if(in_array('15',$selectedbonus))  {{'selected'}}  @endif>@lang('15:00')</option>
                                    <option value="16" @if(in_array('16',$selectedbonus))  {{'selected'}}  @endif>@lang('16:00')</option>
                                    <option value="17" @if(in_array('17',$selectedbonus))  {{'selected'}}  @endif>@lang('17:00')</option>
                                    <option value="18" @if(in_array('18',$selectedbonus))  {{'selected'}}  @endif>@lang('18:00')</option>
                                    <option value="19" @if(in_array('19',$selectedbonus))  {{'selected'}}  @endif>@lang('19:00')</option>
                                    <option value="20" @if(in_array('20',$selectedbonus))  {{'selected'}}  @endif>@lang('20:00')</option>
                                    <option value="21" @if(in_array('21',$selectedbonus))  {{'selected'}}  @endif>@lang('21:00')</option>
                                    <option value="22" @if(in_array('22',$selectedbonus))  {{'selected'}}  @endif>@lang('22:00')</option>
                                    <option value="23" @if(in_array('23',$selectedbonus))  {{'selected'}}  @endif>@lang('23:00')</option>
                                    <option value="0" @if(in_array('0',$selectedbonus))  {{'selected'}}  @endif>@lang('24:00')</option>
                                </select>
                            </div>
        ...
        (function($){
            ...
            function matchingBonus(matching_bonus_time) {
                if (matching_bonus_time == 'daily') {
                    ...
                    document.getElementById('daily_twice_time').style.display = 'none'
                ...
                }else if (matching_bonus_time == 'daily_twice') {
                    document.getElementById('weekly_time').style.display = 'none';
                    document.getElementById('monthly_time').style.display = 'none'
                    document.getElementById('daily_time').style.display = 'none'
                    document.getElementById('daily_twice_time').style.display = 'block'
