                ...
                <div class="card-body p-0">
                    <div class="d-flex p-3 bg--primary">
                        <div class="avatar avatar--lg">
                            <img src="{{ getImage('assets/images/user/profile/'. $user->image, null, true)}}" alt="@lang('Image')">
                        </div>
                        <div class="pl-3">
        ...
        <div class="col-lg-9 col-md-9 mb-30">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.users.password.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
...
@push('breadcrumb-plugins')
    <a href="{{route('admin.users.detail',$user->id)}}" class="btn btn-sm btn--primary box--shadow1 text--small" ><i class="fa fa-user"></i>@lang('Back to Profile')</a>
@endpush
