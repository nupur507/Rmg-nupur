                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label  font-weight-bold">@lang('Last Name') <span
                                            class="text-danger">*</span></label>
                                    <input class="form-control form-control-lg" type="text" name="lastname" value="{{auth()->user()->lastname}}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control form-control-lg" type="email" value="{{auth()->user()->email}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Nominee Name') <span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="nominee_name" value="{{$user->nominee_name}}">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label  font-weight-bold">@lang('Nominee Relation') <span
                                            class="text-danger">*</span></label>
                                            <select name="nominee_relation" class="form-control"> @include('partials.relation') </select>
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Nominee DOB') <span
                                            class="text-danger">*</span></label>
                                    <input class="form-control" type="date" name="nominee_dob" value="{{$user->nominee_dob}}">
                                </div>
                            </div>
...
<a href="{{route('user.update-kyc')}}" class="btn btn--danger btn--shadow"><i class="fa fa-key"></i>@lang('Update KYC')</a>
<a href="{{route('user.update-bank')}}" class="btn btn--info btn--shadow"><i class="fa fa-key"></i>@lang('Update Bank Details')</a>
