            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('user.profile-setting') }}">
                    <a href="{{ route('user.profile-setting') }}" class="nav-link">
                        ...
                        <span class="menu-title">@lang('Profile & KYC')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('user.report*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('user.report.starCom')}}">
                                <a href="{{route('user.report.starCom')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Star Commissions')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('user.report.superCom')}}">
                                <a href="{{route('user.report.superCom')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Super Star Commissions')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('user.report.rubyCom')}}">
                                <a href="{{route('user.report.rubyCom')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Ruby Star Commissions')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('user.report.diamondCom')}}">
                                <a href="{{route('user.report.diamondCom')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Diamond Star Commissions')</span>
                                </a>
                            </li>
