                    ...
                    <div class="user-details-modal">
                        <div class="user-details-header ">
                            ...
                            <div class="content">
                                ...
                                <span class="user-status tree_username"></span><br>
                                <span class="user-status tree_status"></span>
                                <span class="user-status tree_plan"></span><br>
                                <span class="">Direct Member: <span class="user-status tree_direct"></span></span>

                            </div>
                        </div>
                        <div class="user-details-body text-center">
                            {{-- <h6 class="my-3">@lang('Total Direct Member'): <span class="tree_direct"></span></h6> --}}
    ...
    <script>
        ...
        (function ($) {
            $('.showDetails').on('click', function () {
                ...
                $('.tree_direct').text($(this).data('dpaid'));
