...
class ManageUsersController extends Controller
{
    ...
    {
        $page_title = 'Manage KYC';
        $empty_message = 'No user found';
        $kycs = UserKyc::latest()->with('user')->paginate(getPaginate());
        return view('admin.users.kyclist', compact('page_title', 'empty_message', 'kycs'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $user->lastname = $request->lastname;
        $user->nominee_dob =Carbon::parse($request->nominee_dob)->toDateString();
    ...
    public function password($id)
    {
        ...
        $user = User::findOrFail($id);
        return view('admin.users.password', compact('page_title', 'user'));
    }
    ...
    public function passwordUpdate(Request $request,$id)
    {
        ...
        return redirect()->route('admin.users.password',$user->id)->withNotify($notify);
    }
