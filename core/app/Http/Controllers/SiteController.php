...
class SiteController extends Controller
{
    ...
    public function CheckUsername(Request $request)
    {
        ...
        if ($id == '') {
            ...
            return response()->json(['success' => true, 'msg' => "<span class='help-block'><strong class='text-success'>Referrer username matched</strong></span>
                     <input type='hidden' id='referrer_id' value='$id->id' name='referrer_id'><input type='hidden' id='referrer_name' value='$id->fullname' name='referrer_name'>"]);
    ...
    public function findUsername(Request $request)
    {
        ...
        if ($id == '') {
            return response()->json(['success' => false, 'msg' => "<span class='help-block'><strong class='text-danger'>Id not found</strong></span>"]);
        } else {
            return response()->json(
                ['success' => true,
                'msg' => "<span class='help-block'><strong class='text-success'>Id matched</strong></span>",
                'data' => [
    ...
    public function banker()
    {
        ...
        return view($this->activeTemplate . 'banker', $data);
    }
